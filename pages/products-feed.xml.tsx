...
export const getServerSideProps: GetServerSideProps = async ({ res }) => {
  ...
  // Same rule at the CDN layer, and it has to be conditional too: an unconditional s-maxage=3600
  // here would let Vercel's edge hold an EMPTY feed for an hour even though cacheIfNotEmpty just
  // refused to, which is the delisting bug wearing a different hat.
  if (items.length > 0) {
