...
function getFallbackProducts(region: RegionCode): Product[] {
  ...
  const fallbacks: Record<string, Product[]> = {
    il: [
      { id: 'f1', productId: '1005007001', title: 'מטען אלחוטי מהיר 15W', description: 'מטען מגנטי אוניברסלי לאייפון ואנדרואיד', price: 39.90, currency: 'ILS', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.08, rating: 4.7, reviewCount: 2341, volume: 15000, tags: ['טכנולוגיה', 'מבצע'], category: 'gadgets', region, isHot: true, freeShipping: true },
      { id: 'f2', productId: '1005007002', title: 'אוזניות BT Sport Pro', description: 'אוזניות אלחוטיות עם ביטול רעשים וספורט IPX5', price: 69.90, currency: 'ILS', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.08, rating: 4.6, reviewCount: 5872, volume: 34000, tags: ['אלקטרוניקה', 'ספורט'], category: 'electronics', region, isHot: true, freeShipping: true },
      { id: 'f3', productId: '1005007003', title: 'ערכת מברגים מדויקת 48in1', description: 'ערכת תיקון מקצועית מגנטית עם 48 ראשים', price: 45.00, currency: 'ILS', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.06, rating: 4.9, reviewCount: 3204, volume: 8900, tags: ['כלי עבודה', 'בית'], category: 'home', region, isHot: true, freeShipping: true },
      { id: 'f4', productId: '1005007004', title: 'מנורת לד חכמה עם אפליקציה', description: 'שלט רחוק + אפליקציה, 16 מליון צבעים', price: 28.50, currency: 'ILS', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.08, rating: 4.5, reviewCount: 1876, volume: 22000, tags: ['בית חכם', 'תאורה'], category: 'home', region, isHot: false, freeShipping: true },
      { id: 'f5', productId: '1005007005', title: 'שעון חכם ספורט IP68', description: 'מד דופק, לחץ דם, חמצן בדם, 20 מצבי ספורט', price: 89.90, currency: 'ILS', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.10, rating: 4.4, reviewCount: 8901, volume: 0, tags: ['ספורט', 'טכנולוגיה'], category: 'sports', region, isHot: true, freeShipping: true },
      { id: 'f6', productId: '1005007006', title: 'פנס לד חזק 2000LM', description: 'פנס טקטי נטען USB-C, עמיד למים', price: 34.90, currency: 'ILS', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.06, rating: 4.8, reviewCount: 2341, volume: 0, tags: ['כלי עבודה', 'חוץ'], category: 'outdoor', region, isHot: true, freeShipping: true },
    ],
    eu: [
      { id: 'e1', productId: '1005007001', title: '15W Fast Wireless Charger', description: 'Magnetic universal charger for iPhone & Android', price: 9.90, currency: 'EUR', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.08, rating: 4.7, reviewCount: 2341, volume: 0, tags: ['Tech', 'Deal'], category: 'gadgets', region, isHot: true, freeShipping: true },
      { id: 'e2', productId: '1005007002', title: 'Sport Bluetooth Earbuds Pro', description: 'Wireless noise-cancelling earbuds IPX5 waterproof', price: 18.90, currency: 'EUR', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.08, rating: 4.6, reviewCount: 5872, volume: 0, tags: ['Electronics', 'Sports'], category: 'electronics', region, isHot: true, freeShipping: true },
      { id: 'e3', productId: '1005007003', title: 'Precision Screwdriver Set 48in1', description: 'Professional magnetic repair kit with 48 bits', price: 11.50, currency: 'EUR', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.06, rating: 4.9, reviewCount: 3204, volume: 0, tags: ['Tools', 'Home'], category: 'home', region, isHot: true, freeShipping: true },
      { id: 'e4', productId: '1005007004', title: 'Smart LED Lamp WiFi+App', description: 'Remote + app control, 16 million colors', price: 7.50, currency: 'EUR', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.08, rating: 4.5, reviewCount: 1876, volume: 0, tags: ['Smart Home', 'Lighting'], category: 'home', region, isHot: false, freeShipping: true },
      { id: 'e5', productId: '1005007005', title: 'IP68 Smart Sports Watch', description: 'Heart rate, blood pressure, SPO2, GPS, 20 sports modes', price: 22.90, currency: 'EUR', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.10, rating: 4.4, reviewCount: 8901, volume: 0, tags: ['Sports', 'Tech'], category: 'sports', region, isHot: true, freeShipping: true },
      { id: 'e6', productId: '1005007006', title: '2000LM LED Tactical Flashlight', description: 'USB-C rechargeable, waterproof, zoomable', price: 8.90, currency: 'EUR', currencySymbol: s, imageUrl: '', affiliateLink: '#', commissionRate: 0.06, rating: 4.8, reviewCount: 2341, volume: 0, tags: ['Outdoor', 'Tools'], category: 'outdoor', region, isHot: true, freeShipping: true },
    ],
  };
